class HomeController < ApplicationController
  ...
  def bilan
    ...
    @age_moyen ||= Dossier.average(:age).round(2)
    @age_sd ||= Math.sqrt(
      Dossier.sum(
    ...
    @sa_moyen ||= Dossier.average(:sa).round(2)
    @sa_sd ||= Math.sqrt(
      Dossier.sum(
    ...
    @parite = Dossier.average(:nai).round(2)
    @parite_sd ||= Math.sqrt(
      Dossier.sum(
    ...
    @gestite = Dossier.average(:gestite).round(2)
    ...
    @solvage_moyen ||= @solvants.average(:age).round(2)
    ...
    @solvsa_moyen ||= @solvants.average(:sa).round(2)
    @solvsa_sd ||= Math.sqrt(
      @solvants.sum(
    ...
    @solv_parite = @solvants.average(:nai).round(2)
    ...
    @solv_gestite = @solvants.average(:gestite).round(2)
    ...
    @autres_age_moyen ||= @autres.average(:age).round(2)
    ...
    @autres_sa_moyen ||= @autres.average(:sa).round(2)
    ...
    @autres_parite = @autres.average(:nai).round(2)
    ...
    @autres_gestite = @autres.average(:gestite).round(2)
